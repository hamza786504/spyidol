                ...
                >
                    <Row gutter={[20, 8]} justify="center">
                        <Col xs={{ span: 24 }} sm={{ span: 12 }} md={{ span : 8}} lg={{ span : 8}} span={8} style={{textAlign : "center"}}>
                            <h4 style={{ fontSize : "17px"}}>Cartao CNPJ</h4>
                            <Dragger {...props}>
                                <div style={{position : "relative" , height : "100%" , display: "flex" , alignItems : "center" , justifyContent : "center"}}>
                                <Image src="/images/doc_image_1.png" height='60' width='70' objectFit='contain' />
                                <Link style={{position : "absolute" , bottom : "20px" , left: 0 , right : 0 , textDecoration : "underline" , color : "#FE6330" , fontSize : "16px"}}>Foto do Cartão CNPJ</Link>
                                </div>
                            </Dragger>
                        </Col>
                        <Col xs={{ span: 24 }} sm={{ span: 12 }} md={{ span : 8}} lg={{ span : 8}} span={8} style={{textAlign : "center"}}>
